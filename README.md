...
* [DoReMIFaSol](https://github.com/InseeFrLab/DoReMIFaSol) par [@pierre-lamarche](https://github.com/pierre-lamarche) : récupérer et utiliser les données de l'Insee avec R
